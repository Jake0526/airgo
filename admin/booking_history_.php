...
$conn->query(" 
    ...
    SELECT 
        user_id, full_name AS name, email, service, location, appointment_date, appointment_time,
        phone_number, 
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    foreach ($history as $row) {
        ...
        fputcsv($output, [
            ...
            $row['appointment_date'], $normalTime, $row['phone_number'],
    ...
    <?php else: ?>
        ...
        foreach ($history as $row):
            ...
            if ($date !== $lastDate):
                ...
                echo "<table><tr><th>Name</th><th>Email</th><th>Service</th><th>Location</th><th>Date & Time</th><th>Phone</th><th>Status</th></tr>";
                $lastDate = $date;
            endif;
