    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-image: url('airgo logo.jpg'); /* Add the path to your background image */
        ...
        .login-container {
            background-color: rgba(255, 255, 255, 0.8); /* Transparent white background for the container */
            padding: 30px;
            border-radius: 8px;
